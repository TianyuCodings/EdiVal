...
def generate():
    ...
    # for kk in range(3):
        try:
            ...
            if len(prompt) == 1:
                prompt = prompt[0].strip('.').strip('"').strip('\'')+ '.'
            else:
            ...
            for part in response.candidates[0].content.parts:
                if part.text is not None:
                    ...
                    save_path = './nano_banana/singlepass/' + str(image_idx)+f'_input_raw_turn_{turns}.png'
